                        ...
                        <form action="code.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea name="description" class="form-control rounded-5 h-75" rows="3"></textarea>
                                </div>
                               
                                <div class="col-md-6 mb-2 text-end">
                                    <button type="submit" name="saveCategory" class="btn btn-success rounded-5 w-25">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
