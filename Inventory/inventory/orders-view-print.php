...
<div class="container-fluid bg-white">
    <div class="card mt-3 shadow-sm col-md-11" style="margin: 0 1.2rem;">
        <div class="card-header bg-white">
            ...
            <a href="orders.php" class="btn btn-success float-end rounded-5 px-4">Back</a>
            </h4>
        </div>
        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="customer-details">
                                        ...
                                        <p>Customer Full Name: <?= $orderDataRow['name'] ?></p>
                                    ...
                                    <td class="invoice-details">
                                        ...
                                        <?php
                                        $datetime = new DateTime($orderDataRow ['order_date'], new DateTimeZone('UTC')); // Assuming UTC is stored
                                        $datetime->setTimezone(new DateTimeZone('Asia/Pontianak')); // Local timezone
                                        ?>
                                         <p>Invoice Date: <?= $datetime->format('d M, Y h:i:s A'); ?></p>
                                        <p>Room No.:</p>
                                    </td>
                                </tr>
                            </tbody>
