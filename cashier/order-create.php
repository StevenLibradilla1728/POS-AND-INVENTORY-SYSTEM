...
if (isset($_GET['id'])) {
    ...
    // Fetch the phone number and store it in a session
    $query = "SELECT phone FROM customer WHERE cid = '$customerId' LIMIT 1";
    $result = mysqli_query($conn, $query);
    if ($result && mysqli_num_rows($result) > 0) {
        $customer = mysqli_fetch_assoc($result);
        $_SESSION['customer_phone'] = $customer['phone']; // Store in session
    } else {
        $_SESSION['customer_phone'] = ''; // Clear if no phone found
    }
}
?>
...
<div class="container-fluid mt-0 bg-white" style="margin-left: 0px;padding-left:0px;"> 
    <div class="row bg-white" style="margin-left:0px;">
        <!-- Products Section -->
        <div class="col-md-8" style="margin-top: 0;margin-bottom:3rem;margin-left:0px">
        <?php alertMessage(); ?>
...
<form action="orders-code.php" method="POST">
                            ...
                            <div class="mt-2 mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-7 mb-3" style="margin-left: 2rem;width: 16rem;">
                                        ...
                                        <!--<option value="" disabled>Select Payment</option>-->
                                            ...
                                            <option disabled value="Online Payment">Online Payment</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <!--<div class="row">
                                    <div class="col-md-7 mb-2" style="margin-left: 2rem;width: 16rem;">
                                       <label for="">Customer Phone No.</label>
                                       <br>
                                       <input type="number" id="cphone" class="form-control mb-1" style="height:35px;">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-7 mb-2" style="margin-left: 2rem;width: 16rem;">
                                        <label for="">Customer Phone No.</label>
                                        <br>
                                        <input type="number" id="cphone" class="form-control mb-1" style="height:35px;" value="<?php echo isset($_GET['id']) ? getCustomerPhone($_GET['id']) : ''; ?>">
                                    </div>
                                </div>-->
    ...
    <div class="col-md-7 mb-2" style="margin-left: 2rem;width: 16rem;">
        <label for="">Customer Phone No.</label>
        <br>
        <input type="number" id="cphone" name="cphone" class="form-control mb-1" style="height:35px;" 
               value="<?php echo isset($_SESSION['customer_phone']) ? $_SESSION['customer_phone'] : ''; ?>">
    </div>
</div>
