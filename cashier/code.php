...
if(isset($_POST['saveCustomer']))
{
    ...
    if($name != '')
    {
        ...
        $phoneCheck = mysqli_query($conn, "SELECT * FROM customer WHERE phone='$phone'");
...
if(isset($_POST['updateCustomer']))
{
    ...
    if($name != '')
    {
        ...
        $phoneCheck = mysqli_query($conn, "SELECT * FROM customer WHERE phone='$phone' AND id!='$customerId'");       
